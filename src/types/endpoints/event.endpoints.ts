...
export interface CreateEventHandler
  extends RequestHandler<
    unknown,
    successResponse<{ data: Ievent }>,
    Pick<Ievent, 'cost' | 'cover' | 'details' | 'location' | 'title' | 'date'>,
    unknown
  > {}
...
export interface UpdateEventHandler
  extends RequestHandler<
    { eventId: string },
    successResponse<{ data: Ievent }>,
    Partial<Pick<Ievent, 'cost' | 'cover' | 'location' | 'title' | 'date'>>,
    unknown
  > {}
...
export interface BookEventHandler
  extends RequestHandler<
    unknown,
    successResponse<{ data: IeventBook }>,
    Pick<IeventBook, 'event' | 'user' | 'pointDiscount' | 'stuffDiscount'>,
    unknown
  > {}
