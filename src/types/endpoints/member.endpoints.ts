...
extends RequestHandler<unknown , successResponse<{data:Imember}> , Pick<Imember , 'details' | 'title' | 'price'> , unknown>{}

export interface UpdateMemberHandler
extends RequestHandler<{memberId:string} , successResponse<{data:Imember}> , Pick<Imember ,'title' | 'price'> , unknown>{}
