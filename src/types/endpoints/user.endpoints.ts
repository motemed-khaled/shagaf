...
export interface SignUpHandler
  extends RequestHandler<
    unknown,
    successResponse,
    Pick<Iusers, 'birthdate' | 'phone' | 'username' | 'password' | 'email'>,
    unknown
  > {}
...
export interface VerifyUserHandler
  extends RequestHandler<
    unknown,
    successResponse<{ email: string; reason: string }>,
...
export interface UpdateLoggedUserHandler
  extends RequestHandler<
    unknown,
    successResponse<{ data: Iusers }>,
    Pick<Iusers, 'birthdate' | 'phone' | 'username'>,
    unknown
  > {}
...
export interface CreateUserHandler
  extends RequestHandler<
    unknown,
    successResponse<{ data: Iusers }>,
    Pick<Iusers, 'birthdate' | 'phone' | 'username' | 'password' | 'email' | 'userType'>,
    unknown
  > {}
...
export interface UpdateUserHandler
  extends RequestHandler<
    { userId: string },
    successResponse<{ data: Iusers }>,
    Partial<Pick<Iusers, 'birthdate' | 'phone' | 'username' | 'password' | 'email' | 'userType'>>,
    unknown
  > {}
...
export interface GetUserPointsDiscountHandler
  extends RequestHandler<
    { userId: string },
    successResponse<{ data: { discount: number } }>,
    unknown,
    unknown
  > {}
