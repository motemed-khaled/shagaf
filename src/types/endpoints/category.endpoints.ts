...
extends RequestHandler<unknown , successResponse<{data:Icategory}> , Pick<Icategory , 'cover' | 'title'> , unknown >{}

export interface UpdateCategoryHandler
extends RequestHandler<{categoryId:string} , successResponse<{data:Icategory}> , Partial<Pick<Icategory , 'cover' | 'title'>> , unknown>{}
...
extends RequestHandler<{categoryId:string} , successResponse<{data:Icategory}> , unknown , unknown>{}
