...
import { UpdateDetailsHandler } from '../../types/endpoints/event.endpoints';
import { NotFoundError } from '../../utils/errors/notfound-error';

export const updateDetailHandler: UpdateDetailsHandler = async (req, res, next) => {
  ...
  event.details[index].title = req.body.title;
  await event.save();
